...
import ru.vsu.cs.garaba.binaryTree.IBinaryTree;
...
public class BinaryTreePainter
{
    ...
    private static <T extends Comparable<T>> NodeDrawResult paint(IBinaryTree.TreeNode<T> node, Graphics2D g2d,
                                                                  int x, int y)
    {
        if (node == null)
        {
    ...
    public static <T extends Comparable<T>> Dimension paint(IBinaryTree<T> tree, Graphics gr)
    {
